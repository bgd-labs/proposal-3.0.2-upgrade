...
+   */
   function getCaps(DataTypes.ReserveConfigurationMap memory self)
     internal
     pure
@@ -1328,17 +1355,17 @@ library Address {
 /**
...
@@ -1348,13 +1375,14 @@ interface IScaledBalanceToken {
   );
...
@@ -1369,7 +1397,7 @@ interface IScaledBalanceToken {
...
+   */
   ...
   /**
@@ -1377,20 +1405,20 @@ interface IScaledBalanceToken {
...
@@ -1398,181 +1426,28 @@ interface IScaledBalanceToken {
...
@@ -1667,7 +1542,7 @@ interface IPoolAddressesProvider {
   /**
...
+   */
   ...
   /**
@@ -1709,27 +1584,27 @@ interface IPoolAddressesProvider {
   /**
...
+   */
   ...
   /**
@@ -1753,7 +1628,7 @@ interface IPoolAddressesProvider {
   /**
...
+   */
   ...
   /**
@@ -1777,7 +1652,7 @@ interface IPoolAddressesProvider {
   /**
...
+   */
   ...
   /**
@@ -1789,7 +1664,7 @@ interface IPoolAddressesProvider {
   /**
...
@@ -1797,7 +1672,7 @@ interface IPoolAddressesProvider {
  * @title IPool
  * @author Aave
...
+   */
   event SwapBorrowRateMode(
     address indexed reserve,
     address indexed user,
@@ -1909,28 +1784,28 @@ interface IPool {
...
@@ -1996,17 +1871,17 @@ interface IPool {
...
+   */
   function mintUnbacked(
     address asset,
     uint256 amount,
@@ -2015,16 +1890,17 @@ interface IPool {
   ) external;
...
+   */
   ...
   /**
@@ -2189,14 +2065,14 @@ interface IPool {
...
+   */
   function getConfiguration(address asset)
     external
     view
@@ -2344,14 +2220,14 @@ interface IPool {
...
+   * @notice Returns the normalized income of the reserve
    ...
    */
@@ -2359,6 +2235,13 @@ interface IPool {
...
+   */
   ...
   /**
@@ -2394,20 +2277,20 @@ interface IPool {
...
@@ -2551,7 +2434,7 @@ interface IInitializableAToken {
...
@@ -2590,15 +2473,15 @@ interface IInitializableAToken {
  * @title IAToken
  * @author Aave
...
+   */
   ...
   /**
@@ -2624,7 +2507,7 @@ interface IAToken is IERC20, IScaledBalanceToken, IInitializableAToken {
...
@@ -2644,7 +2527,7 @@ interface IAToken is IERC20, IScaledBalanceToken, IInitializableAToken {
...
+   */
   function transferOnLiquidation(
     address from,
     address to,
@@ -2654,10 +2537,10 @@ interface IAToken is IERC20, IScaledBalanceToken, IInitializableAToken {
   /**
...
@@ -2665,9 +2548,14 @@ interface IAToken is IERC20, IScaledBalanceToken, IInitializableAToken {
...
@@ -2694,13 +2582,13 @@ interface IAToken is IERC20, IScaledBalanceToken, IInitializableAToken {
   /**
...
+   */
   ...
   /**
@@ -2714,7 +2602,7 @@ interface IAToken is IERC20, IScaledBalanceToken, IInitializableAToken {
...
+   */
   ...
   /**
@@ -2737,7 +2625,7 @@ interface IAToken is IERC20, IScaledBalanceToken, IInitializableAToken {
...
@@ -2754,7 +2642,7 @@ library WadRayMath {
    * @param a Wad
    * @param b Wad
    * @return c = a*b, in wad
-   **/
+   */
   function wadMul(uint256 a, uint256 b) internal pure returns (uint256 c) {
     ...
     assembly {
@@ -2772,7 +2660,7 @@ library WadRayMath {
    * @param a Wad
    * @param b Wad
    * @return c = a/b, in wad
-   **/
+   */
   function wadDiv(uint256 a, uint256 b) internal pure returns (uint256 c) {
     ...
     assembly {
@@ -2790,7 +2678,7 @@ library WadRayMath {
    * @param a Ray
    * @param b Ray
    * @return c = a raymul b
-   **/
+   */
   function rayMul(uint256 a, uint256 b) internal pure returns (uint256 c) {
     ...
     assembly {
@@ -2808,7 +2696,7 @@ library WadRayMath {
    * @param a Ray
    * @param b Ray
    * @return c = a raydiv b
-   **/
+   */
   function rayDiv(uint256 a, uint256 b) internal pure returns (uint256 c) {
     ...
     assembly {
@@ -2825,7 +2713,7 @@ library WadRayMath {
...
@@ -2841,7 +2729,7 @@ library WadRayMath {
    * @dev assembly optimized for improved gas savings, see https://twitter.com/transmissions11/status/1451131036377571328
    * @param a Wad
...
+   */
   function wadToRay(uint256 a) internal pure returns (uint256 b) {
     ...
     assembly {
@@ -2858,7 +2746,7 @@ library WadRayMath {
...
@@ -2869,7 +2757,7 @@ interface IInitializableDebtToken {
...
+   */
   event Initialized(
     address indexed underlyingAsset,
     address indexed pool,
@@ -2906,19 +2794,19 @@ interface IInitializableDebtToken {
  * @author Aave
...
+   */
   event Mint(
     address indexed user,
     address indexed onBehalfOf,
@@ -2934,11 +2822,11 @@ interface IStableDebtToken is IInitializableDebtToken {
...
+   */
   event Burn(
     address indexed from,
     uint256 amount,
@@ -2960,7 +2848,7 @@ interface IStableDebtToken is IInitializableDebtToken {
...
+   */
   function mint(
     address user,
     address onBehalfOf,
@@ -2984,27 +2872,27 @@ interface IStableDebtToken is IInitializableDebtToken {
...
+   */
   ...
   /**
@@ -3013,7 +2901,7 @@ interface IStableDebtToken is IInitializableDebtToken {
...
+   */
   function getSupplyData()
     external
     view
@@ -3027,26 +2915,26 @@ interface IStableDebtToken is IInitializableDebtToken {
   /**
...
@@ -3054,7 +2942,7 @@ interface IStableDebtToken is IInitializableDebtToken {
...
@@ -3065,7 +2953,7 @@ interface IVariableDebtToken is IScaledBalanceToken, IInitializableDebtToken {
...
+   */
   function mint(
     address user,
     address onBehalfOf,
@@ -3081,7 +2969,7 @@ interface IVariableDebtToken is IScaledBalanceToken, IInitializableDebtToken {
...
+   */
   function burn(
     address from,
     uint256 amount,
@@ -3091,7 +2979,7 @@ interface IVariableDebtToken is IScaledBalanceToken, IInitializableDebtToken {
   /**
...
@@ -3101,25 +2989,13 @@ interface IVariableDebtToken is IScaledBalanceToken, IInitializableDebtToken {
...
+   */
   function calculateInterestRates(DataTypes.CalculateInterestRatesParams memory params)
     external
     view
@@ -3146,7 +3022,7 @@ library MathUtils {
...
+   */
   function calculateLinearInterest(uint256 rate, uint40 lastUpdateTimestamp)
     internal
     view
@@ -3174,7 +3050,7 @@ library MathUtils {
    * @param rate The interest rate, in ray
    * @param lastUpdateTimestamp The timestamp of the last update of the interest
...
@@ -3217,7 +3093,7 @@ library MathUtils {
    * @param rate The interest rate (in ray)
...
+   */
   function calculateCompoundedInterest(uint256 rate, uint40 lastUpdateTimestamp)
     internal
     view
@@ -3233,7 +3109,7 @@ library MathUtils {
...
@@ -3247,7 +3123,7 @@ library PercentageMath {
...
+   */
   function percentMul(uint256 value, uint256 percentage) internal pure returns (uint256 result) {
     ...
     assembly {
@@ -3270,7 +3146,7 @@ library PercentageMath {
    * @param value The value of which the percentage needs to be calculated
    * @param percentage The percentage of the value to be calculated
...
+   */
   function percentDiv(uint256 value, uint256 percentage) internal pure returns (uint256 result) {
     ...
     assembly {
@@ -3569,7 +3445,7 @@ library ReserveLogic {
...
+   */
   function getNormalizedIncome(DataTypes.ReserveData storage reserve)
     internal
     view
@@ -3595,7 +3471,7 @@ library ReserveLogic {
...
+   */
   function getNormalizedDebt(DataTypes.ReserveData storage reserve)
     internal
     view
@@ -3619,13 +3495,22 @@ library ReserveLogic {
...
+    reserve.lastUpdateTimestamp = uint40(block.timestamp);
   ...
   /**
@@ -3635,7 +3520,7 @@ library ReserveLogic {
...
@@ -3657,7 +3542,7 @@ library ReserveLogic {
...
+   */
   function init(
     DataTypes.ReserveData storage reserve,
     address aTokenAddress,
@@ -3689,7 +3574,7 @@ library ReserveLogic {
...
+   */
   function updateInterestRates(
     DataTypes.ReserveData storage reserve,
     DataTypes.ReserveCache memory reserveCache,
@@ -3709,9 +3594,7 @@ library ReserveLogic {
...
@@ -3751,7 +3634,7 @@ library ReserveLogic {
    * specific asset.
...
+   */
   function _accrueToTreasury(
     DataTypes.ReserveData storage reserve,
     DataTypes.ReserveCache memory reserveCache
@@ -3804,15 +3687,14 @@ library ReserveLogic {
...
@@ -3822,23 +3704,22 @@ library ReserveLogic {
...
+    }
   ...
   /**
@@ -3856,8 +3737,9 @@ library ReserveLogic {
...
@@ -3891,27 +3773,27 @@ library ReserveLogic {
...
@@ -3996,7 +3878,7 @@ library UserConfiguration {
...
@@ -4018,7 +3900,7 @@ library UserConfiguration {
    * @param self The configuration object
    * @param reserveIndex The index of the reserve in the bitmap
...
+   */
   function setUsingAsCollateral(
     DataTypes.UserConfigurationMap storage self,
     uint256 reserveIndex,
@@ -4040,7 +3922,7 @@ library UserConfiguration {
    * @param self The configuration object
    * @param reserveIndex The index of the reserve in the bitmap
...
+   */
   function isUsingAsCollateralOrBorrowing(
     ...
     uint256 reserveIndex
@@ -4056,7 +3938,7 @@ library UserConfiguration {
    * @param self The configuration object
    * @param reserveIndex The index of the reserve in the bitmap
...
+   */
   function isBorrowing(DataTypes.UserConfigurationMap memory self, uint256 reserveIndex)
     internal
     pure
@@ -4073,7 +3955,7 @@ library UserConfiguration {
    * @param self The configuration object
    * @param reserveIndex The index of the reserve in the bitmap
...
+   */
   function isUsingAsCollateral(DataTypes.UserConfigurationMap memory self, uint256 reserveIndex)
     internal
     pure
@@ -4090,7 +3972,7 @@ library UserConfiguration {
...
+   */
   function isUsingAsCollateralOne(DataTypes.UserConfigurationMap memory self)
     internal
     pure
@@ -4104,7 +3986,7 @@ library UserConfiguration {
...
+   */
   function isUsingAsCollateralAny(DataTypes.UserConfigurationMap memory self)
     internal
     pure
@@ -4118,7 +4000,7 @@ library UserConfiguration {
    * @dev this uses a simple trick - if a number is a power of two (only one bit set) then n & (n - 1) == 0
    * @param self The configuration object
    * @return True if the user has been supplying as collateral one reserve, false otherwise
-   **/
...
@@ -4128,7 +4010,7 @@ library UserConfiguration {
...
@@ -4137,7 +4019,7 @@ library UserConfiguration {
...
@@ -4293,7 +4175,7 @@ library EModeLogic {
...
@@ -4321,7 +4203,7 @@ library EModeLogic {
...
+   */
   function isInEModeCategory(uint256 eModeUserCategory, uint256 eModeAssetCategory)
     internal
     pure
@@ -4379,7 +4261,7 @@ library GenericLogic {
...
@@ -4521,7 +4403,7 @@ library GenericLogic {
...
@@ -4547,7 +4429,7 @@ library GenericLogic {
...
+   */
   function _getUserDebtInBaseCurrency(
     address user,
     DataTypes.ReserveData storage reserve,
@@ -4580,7 +4462,7 @@ library GenericLogic {
...
+   */
   function _getUserBalanceInBaseCurrency(
     address user,
     DataTypes.ReserveData storage reserve,
@@ -4632,10 +4514,11 @@ library ValidationLogic {
...
@@ -4648,9 +4531,8 @@ library ValidationLogic {
...
@@ -4839,7 +4721,7 @@ library ValidationLogic {
...
@@ -4905,20 +4787,6 @@ library ValidationLogic {
...
@@ -4960,7 +4828,7 @@ library ValidationLogic {
...
+       */
       ...
       require(
@@ -5046,10 +4914,7 @@ library ValidationLogic {
   ) internal view {
...
@@ -5061,6 +4926,7 @@ library ValidationLogic {
...
@@ -5215,7 +5081,7 @@ library ValidationLogic {
...
+   */
   function validateDropReserve(
     mapping(uint256 => address) storage reservesList,
     DataTypes.ReserveData storage reserve,
@@ -5228,7 +5094,10 @@ library ValidationLogic {
...
+    );
   ...
   /**
@@ -5239,7 +5108,7 @@ library ValidationLogic {
...
+   */
   function validateSetUserEMode(
     mapping(address => DataTypes.ReserveData) storage reservesData,
     mapping(uint256 => address) storage reservesList,
@@ -5287,7 +5156,7 @@ library ValidationLogic {
    * @param userConfig the user configuration
...
+   */
   function validateUseAsCollateral(
     mapping(address => DataTypes.ReserveData) storage reservesData,
     mapping(uint256 => address) storage reservesList,
@@ -5324,7 +5193,7 @@ library PoolLogic {
    * @param reservesList The addresses of all the active reserves
...
+   */
   function executeInitReserve(
     mapping(address => DataTypes.ReserveData) storage reservesData,
     mapping(uint256 => address) storage reservesList,
@@ -5374,7 +5243,7 @@ library PoolLogic {
    * @notice Mints the assets accrued through the reserve factor to the treasury in the form of aTokens
...
+   */
   function executeMintToTreasury(
     mapping(address => DataTypes.ReserveData) storage reservesData,
     address[] calldata assets
@@ -5422,7 +5291,7 @@ library PoolLogic {
    * @param reservesData The state of all the reserves
    * @param reservesList The addresses of all the active reserves
    * @param asset The address of the underlying asset of the reserve
-   **/
+   */
   function executeDropReserve(
     mapping(address => DataTypes.ReserveData) storage reservesData,
     mapping(uint256 => address) storage reservesList,
@@ -5446,7 +5315,7 @@ library PoolLogic {
    * @return currentLiquidationThreshold The liquidation threshold of the user
    * @return ltv The loan to value of The user
    * @return healthFactor The current health factor of the user
-   **/
+   */
   function executeGetUserAccountData(
     mapping(address => DataTypes.ReserveData) storage reservesData,
     mapping(uint256 => address) storage reservesList,
@@ -5528,7 +5397,7 @@ library SupplyLogic {
...
@@ -5596,6 +5465,13 @@ library SupplyLogic {
...
+
     IAToken(reserveCache.aTokenAddress).burn(
       msg.sender,
       params.to,
@@ -5603,25 +5479,18 @@ library SupplyLogic {
       reserveCache.nextLiquidityIndex
     );
...
@@ -5732,7 +5601,12 @@ library SupplyLogic {
...
@@ -5762,7 +5636,7 @@ library SupplyLogic {
  * @author Aave
...
@@ -5793,7 +5667,7 @@ interface IFlashLoanReceiver {
  * @author Aave
  * @notice Defines the basic interface of a flashloan-receiver contract.
  * @dev Implement this interface to develop a flashloan-compatible flashLoanReceiver contract
- **/
...
+   */
   function getUserCurrentDebt(address user, DataTypes.ReserveCache memory reserveCache)
     internal
     view
@@ -6137,7 +6011,11 @@ library BorrowLogic {
       );
     } else {
...
@@ -6446,7 +6324,8 @@ library FlashLoanLogic {
...
@@ -6462,7 +6341,11 @@ library FlashLoanLogic {
       amountPlusPremium
     );
...
+    );
     ...
     emit FlashLoan(
       params.receiverAddress,
@@ -6480,7 +6363,7 @@ library FlashLoanLogic {
...
@@ -6549,7 +6432,7 @@ library LiquidationLogic {
...
+   */
   function executeLiquidationCall(
     mapping(address => DataTypes.ReserveData) storage reservesData,
     mapping(uint256 => address) storage reservesList,
@@ -6623,6 +6506,16 @@ library LiquidationLogic {
...
@@ -6648,6 +6541,15 @@ library LiquidationLogic {
...
@@ -6655,13 +6557,6 @@ library LiquidationLogic {
       );
     }
...
-
     ...
     IERC20(params.debtAsset).safeTransferFrom(
       msg.sender,
@@ -6671,6 +6566,7 @@ library LiquidationLogic {
...
@@ -6922,7 +6818,7 @@ library LiquidationLogic {
...
@@ -7028,7 +6924,7 @@ library BridgeLogic {
    * @param onBehalfOf The address that will receive the aTokens
    * @param referralCode Code used to register the integrator originating the operation, for potential rewards.
    *   0 if the action is executed directly by the user, without any middle-man
-   **/
+   */
   function executeMintUnbacked(
     mapping(address => DataTypes.ReserveData) storage reservesData,
     mapping(uint256 => address) storage reservesList,
@@ -7043,7 +6939,7 @@ library BridgeLogic {
...
@@ -7080,20 +6976,22 @@ library BridgeLogic {
...
+  ) external returns (uint256) {
     ...
     reserve.updateState(reserveCache);
@@ -7105,7 +7003,8 @@ library BridgeLogic {
...
@@ -7117,6 +7016,8 @@ library BridgeLogic {
...
@@ -7124,7 +7025,7 @@ library BridgeLogic {
...
+ */
 interface IERC20WithPermit is IERC20 {
   /**
    * @notice Allow passing a signed message to approve spending
@@ -7153,7 +7054,7 @@ interface IERC20WithPermit is IERC20 {
  * @title IACLManager
  * @author Aave
...
@@ -7269,7 +7170,7 @@ interface IACLManager {
...
@@ -7380,16 +7281,16 @@ contract PoolStorage {
...
+   */
   modifier onlyPoolConfigurator() {
     ...
     _;
@@ -7397,7 +7298,7 @@ contract Pool is VersionedInitializable, PoolStorage, IPool {
...
+   */
   modifier onlyPoolAdmin() {
     _onlyPoolAdmin();
     _;
@@ -7405,7 +7306,7 @@ contract Pool is VersionedInitializable, PoolStorage, IPool {
...
+   */
   modifier onlyBridge() {
     _onlyBridge();
     _;
@@ -7450,7 +7351,7 @@ contract Pool is VersionedInitializable, PoolStorage, IPool {
...
@@ -7481,8 +7382,9 @@ contract Pool is VersionedInitializable, PoolStorage, IPool {
     address asset,
     uint256 amount,
     uint256 fee
